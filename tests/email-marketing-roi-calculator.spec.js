...
test.describe('Email Marketing ROI Calculator page', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/calculators/finance/email-marketing-roi-calculator/');
  });
...
test.describe('Finance hub lists the Email Marketing ROI Calculator', () => {
  test('Email Marketing ROI Calculator shows on the Finance hub', async ({ page }) => {
    await page.goto('/calculators/finance/');
    await expect(page.getByRole('link', { name: 'Email Marketing ROI Calculator' }).first()).toBeVisible();
  });
});
